...
namespace ConnectionStringCat_IntegrationTests
{
	...
	public class MenuItemTest
	{
		...
		public void LaunchCommand()
		{
			...
			{
				CommandID menuItemCmd = new CommandID(SergeyUskov.ConnectionStringCat.GuidList.guidConnectionStringCatCmdSet, (int)SergeyUskov.ConnectionStringCat.PkgCmdIDList.switchConnectionStringsCmd);
