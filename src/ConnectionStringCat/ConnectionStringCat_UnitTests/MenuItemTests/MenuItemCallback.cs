...
namespace ConnectionStringCat_UnitTests.MenuItemTests
{
	...
	public class MenuItemTest
	{
		...
		public void InitializeMenuCommand()
		{
			...
			CommandID menuCommandID = new CommandID(SergeyUskov.ConnectionStringCat.GuidList.guidConnectionStringCatCmdSet, (int)SergeyUskov.ConnectionStringCat.PkgCmdIDList.switchConnectionStringsCmd);
